  ...
  return (
    <div className="wf-main-content">
        ...
        <div className="wf-card" style={{ padding: '20px', width: '100%' }}>
          <div className="flex-row gap-16 items-center">
            <div className="flex-col items-center gap-2">
              <div className="wf-placeholder-box interactive" style={{ width: '48px', height: '48px', borderRadius: '50%', fontSize: '11px', background: '#F0ECFC' }} onClick={() => playTextToSpeech(wordData.word)}>
      ...
      <div className="wf-hint-bar">
        <div className="wf-hint-text"><span className="wf-hint-key">P</span> Nghe phát âm <span style={{ marginLeft: '8px' }}><span className="wf-hint-key">Enter</span> Kiểm tra</span></div>
