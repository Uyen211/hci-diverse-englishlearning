...
export default function SpeakingSelect() {
  const navigate = useNavigate()
  const [selectedMode, setSelectedMode] = useState('pronunciation')

  const modes = [
    {
      id: 'pronunciation',
      title: 'Luyện phát âm từng câu',
      desc: 'Nghe mẫu, đọc lại từng câu và nhận phản hồi AI về âm khó, trọng âm, nối âm và nhịp nói.',
      icon: <Volume2 className="w-6 h-6 text-primary" />,
      path: '/student/speaking/pronunciation'
    },
    {
      id: 'roleplay',
      title: 'Hội thoại AI Role-play',
      desc: 'Đóng vai trong tình huống thật, trả lời theo ngữ cảnh và luyện phản xạ giao tiếp tự nhiên.',
      icon: <MessageCircle className="w-6 h-6 text-primary" />,
      path: '/student/speaking/roleplay'
    }
  ]
    ...
    <div className="flex flex-col h-full bg-surface items-center pt-12 pb-20">
      <div className="w-full max-w-4xl px-4">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl font-bold text-text-primary mb-8">Chọn cách luyện phù hợp với mục tiêu: phát âm chính xác, phản xạ hội thoại hoặc trình bày ý tưởng rõ ràng.</h1>
