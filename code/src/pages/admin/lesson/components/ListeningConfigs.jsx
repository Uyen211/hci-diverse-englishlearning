  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
        <div className={`input-group ${errors.audio ? 'error' : ''}`}>
          <label>Tệp âm thanh bài nghe (.mp3) *</label>
          ...
          {errors.audio && <span className="error-message">✕ {errors.audio.message}</span>}
        </div>
      ...
      <div style={{ fontSize: '13px', fontWeight: '700', color: 'var(--text-secondary)', textTransform: 'uppercase', marginTop: '20px' }}>Danh sách câu hỏi tương tác *</div>
      ...
      <div className="sub-questions-manager" style={{ border: '1px solid rgba(78, 86, 192, 0.12)', borderRadius: '12px', padding: '16px', backgroundColor: 'rgba(78, 86, 192, 0.01)' }}>
        <div className="sub-manager-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            <span style={{ fontSize: '13px', fontWeight: '700', color: 'var(--text-secondary)' }}>Câu hỏi tương tác ({questions.length}):</span>
        ...
        {questions[activeQuestionIndex] ? (
          <div className="sub-editor-panel" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div className="input-group">
              <label>Câu hỏi trắc nghiệm (MCQ) *</label>
              <input
                type="text"
                className="input-field"
